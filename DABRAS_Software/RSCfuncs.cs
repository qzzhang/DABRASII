...
namespace DABRAS_Software
{
    public partial class FormRSC
    {
        ...
        private void Update_Form()
        {
            ...
            /************FullDataResults[1, 15].Value and FullDataResults[1, 16].Value can be infinity *********/
            ...
            /*****Change the decimal digits count to 2 for display in the table ***/
            ...
            this.Alpha_Count_TB.Text = String.Format("{0:0.00}±{1}", FullDataResults[1, 17].Value, FullDataResults[1, 19].Value);
            this.Beta_Count_TB.Text = String.Format("{0:0.00}±{1}", FullDataResults[1, 18].Value, FullDataResults[1, 20].Value);
            ...
            //this.Alpha_Activity_TB.Text = String.Format("{0:G11}±{1:G5}", FullDataResults[1, 33].Value, FullDataResults[1, 31].Value);
            //this.Beta_Activity_TB.Text = String.Format("{0:G11}±{1:G5}", FullDataResults[1, 34].Value, FullDataResults[1, 32].Value);
            this.Alpha_Activity_TB.Text = String.Format("{0:0.00}±{1}", FullDataResults[1, 33].Value, FullDataResults[1, 31].Value);
            this.Beta_Activity_TB.Text = String.Format("{0:0.00}±{1}", FullDataResults[1, 34].Value, FullDataResults[1, 32].Value);
            //this.Alpha_Activity_TB.Text = String.Format("{0:0.00}±{1}", StaticMethods.RoundToDecimal(Convert.ToDouble(FullDataResults[1, 33].Value), 2), StaticMethods.RoundToDecimal(Convert.ToDouble(FullDataResults[1, 31].Value), 2));
            //this.Beta_Activity_TB.Text = String.Format("{0:0.00}±{1}", StaticMethods.RoundToDecimal(Convert.ToDouble(FullDataResults[1, 34].Value), 2), StaticMethods.RoundToDecimal(Convert.ToDouble(FullDataResults[1, 32].Value), 2));
        ...
        private void WriteToFiles(int bdgNo, string jobnm)
        {
            ...
            /*Remove the 3 rows that contain the following data:
            "Alpha Mod factor"
            "Beta Mod factor"
            ...
            while (!RowComplete && !ShouldStop)
            {
                ...
                if (!ShouldStop)
                {
                    ...
                    if (IncomingData != null && this.ElapsedTime != 0)
                    {
                        ...
                        GrossAlphaCPMCell.Value = totVala / totTime; //Convert raw counts into CPM.
                        GrossBetaCell.Value = totValb;
                        GrossBetaCPMCell.Value = totValb / totTime; //Convert raw counts into CPM.

                        NetAlphaCPMCell.Value = totVala / totTime - AlphaBackground;
                        NetAlphaUncertaintyCell.Value = Math.Sqrt(Math.Abs(Convert.ToDouble(NetAlphaCPMCell.Value)));
                        // StaticMethods.RoundToDecimal(Math.Sqrt(Math.Abs(Convert.ToDouble(NetAlphaCPMCell.Value))), 2);

                        NetBetaCPMCell.Value = totValb / totTime - BetaBackground;
                        NetBetaUncertaintyCell.Value = Math.Sqrt(Math.Abs(Convert.ToDouble(NetBetaCPMCell.Value)));
                        // StaticMethods.RoundToDecimal(Math.Sqrt(Math.Abs(Convert.ToDouble(NetBetaCPMCell.Value))), 2);
                        ...
                        AlphaLcCell.Value = ConfRange * Math.Sqrt(AlphaBackground * (1.0 / (Convert.ToDouble(BackgroundCountTime) / 60.0) + 1.0 / totTime));
                        BetaLcCell.Value = ConfRange * Math.Sqrt(BetaBackground * (1.0 / (Convert.ToDouble(BackgroundCountTime) / 60.0) + 1.0 / totTime));
                        ...
                        double AlphaLd = (ConfRange * ConfRange) / totTime + 2.0 * Convert.ToDouble(AlphaLcCell.Value);
                        double BetaLd = (ConfRange * ConfRange) / totTime + 2.0 * Convert.ToDouble(BetaLcCell.Value);
                        ...
                        try
                        {
                            ...
                            AlphaSrcMDACell.Value = AlphaLd / (AlphaEfficiency * .01);
                            BetaSrcMDACell.Value = BetaLd / (BetaEfficiency * .01);
                        ...
                        //Net counts
                        AlphaActivityDPMCell.Value = Convert.ToDouble(NetAlphaCPMCell.Value) * 100.0 / AlphaEfficiency;
                        ...
                        AlphaUncetaintyDPMCell.Value = Math.Sqrt(Math.Abs(AlphaDPM));

                        BetaActivityDPMCell.Value = Convert.ToDouble(NetBetaCPMCell.Value) * 100.0 / BetaEfficiency;
                        ...
                        BetaUncertaintyDPMCell.Value = Math.Sqrt(Math.Abs(BetaDPM));
                        ...
                        if (this.Type == FormRSC.RoutineSampleCountType.Time)
                        {
                            ...
                            {
                                RowComplete = true;
                                SamplingTime.Value = SampleTime / 60.0; // StaticMethods.RoundToDecimal(SampleTime / 60.0, 2);
                            }
                        }
