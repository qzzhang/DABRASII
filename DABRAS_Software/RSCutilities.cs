...
{
    public partial class mainFramework
    {
        //RSC component members
        #region Enums
        ...
        private void Update_Form()
        {
            if (RL.IsDone())
            {
                ...
                {
                    disconnectCleanup("Not Connected");
                }
            }
        ...
        private void KeyPressed(object sender, KeyEventArgs Key)
        {
            ...
            if (Key.Control)
            {
                ...
                */
                if (Key.KeyCode == Keys.V)
                {
                    if (btnSaveRSCcsv.Enabled)
                    {
                        btnSaveRSCcsv_Click(this, null);
                    }
                }
        ...
        {
            this.btnSaveRSCcsv.Enabled = !Running;
        ...
        /*Verify sample number, has to be numerical*/
        private bool verifySampleNum()
        {
            int sampleNo = 0;
        ...
        private void autoWriteToFiles()
        {
            if (this.verifySampleNum())
            {
                ...
                string CustomFilePath = String.Format("{0}\\data\\Routine\\{1}\\{2}_{3}_{4}_{5}_{6}_RSC.csv", Environment.CurrentDirectory, smpNo, DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, desc, DABRAS.Serial_Number);
    ...
    public class RoutineSampleListener
    {
        ...
        private mainFramework.RoutineSampleCountType Type;
        ...
        #region Constructor
        public RoutineSampleListener(DABRAS _DABRAS, int _SampleTime, double _MDAStopValue, DataGridView _FullTable, int _AlphaBG, int _BetaBG, double _AlphaE, double _BetaE, double _AlphaAbsorbtion, double _BetaAbsorbtion, double _BetaBackscatter, double _RemovalPercentage, double _Area, int _BGCountTime, mainFramework.RoutineSampleCountType _Type, double _AlphaMDA, double _BetaMDA)
        {
            this.DABRAS = _DABRAS;
            ...
            if (this.Type == mainFramework.RoutineSampleCountType.MDA)
            {
        ...
        public mainFramework.RoutineSampleCountType GetTestType()
        {
            return this.Type;
        }
                ...
                if (!ShouldStop)
                {
                    ...
                    if (IncomingData != null && this.ElapsedTime != 0)
                    {
                        ...
                        */
                        ...
                        if (this.Type == mainFramework.RoutineSampleCountType.Time)
                        {
